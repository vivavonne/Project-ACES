...
select 'MONTHLY_HOARDERS' AS TOTAL_USERS ,(count(Distinct(PersonID))) AS COUNT from
...
where 
SUBMITDATE between (LAST_DAY(SUBMITDATE) - interval '3 day') and LAST_DAY(SUBMITDATE)
